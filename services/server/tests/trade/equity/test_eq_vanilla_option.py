...
if __name__ == '__main__':
    test_pricing_basic(EQVanillaOption)
    test_risk_sensitivity(EQVanillaOption)

    test_pricing_basic(COMVanillaOption)
    test_risk_sensitivity(COMVanillaOption)

    test_pricing_basic(CRYPTOVanillaOption)
    test_risk_sensitivity(CRYPTOVanillaOption)
