...
if __name__ == '__main__':
    test_pricing_basic(EQSpot)
    test_risk_sensitivity(EQSpot)

    test_pricing_basic(COMSpot)
    test_risk_sensitivity(COMSpot)

    test_pricing_basic(CRYPTOSpot)
    test_risk_sensitivity(CRYPTOSpot)
