...
def test2():
    baseTradePath = "project/data/db/OISwap"
    ...
    for i, row in trade_df.iterrows():
        trade = OISwap(
            ...
            overnight_index=row.OvernightIndex,
            overnight_spread=row.OvernightSpread,
            overnight_day_count=row.OvernightDayCount,
...
def test3():
    baseMarketPath = "project/data/db/OISwap"
    baseTradePath = "project/data/db/OISwap"
    basePricingsPath = "project/data/db/OISwap"
