export const cryptoForwardForm = {
  name: 'Crypto Forward',
  category: 'CRYPTO',
  api: 'calculateCryptoForward',
  groups: [
    {
      title: 'Trade Details',
      collapsible: true,
      ...
      fields: [
        {
          ...
          helpText: 'The date at which the crypto forward will be valued'
        },
        {
          key: 'ticker',
          type: 'dropdown',
          ...
          filter: true,
          helpText: 'The cryptocurrency underlying the forward contract'
        },
        {
          key: 'currency',
          type: 'dropdown',
        ...
        },
        {
          ...
          minFractionDigits: 2,
          maxFractionDigits: 4,
          helpText: 'The agreed forward price of the cryptocurrency',
          validators: [
            (value) => {
              if (value <= 0) {
