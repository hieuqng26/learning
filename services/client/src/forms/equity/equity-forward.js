export const equityForwardForm = {
  name: 'Equity Forward',
  category: 'EQUITY',
  api: 'calculateEquityForward',
  groups: [
    {
      title: 'Trade Details',
      collapsible: true,
      ...
      fields: [
        {
          ...
          helpText: 'The date at which the equity forward will be valued'
        },
        {
          key: 'ticker',
          type: 'dropdown',
          ...
          filter: true,
          helpText: 'The equity underlying the forward contract'
        },
        {
          key: 'currency',
          type: 'dropdown',
        ...
        },
        {
          ...
          minFractionDigits: 0,
          maxFractionDigits: 0,
          helpText: 'The number of shares in the forward contract'
        },
        {
          ...
          required: true,
          defaultValue: new Date('2027-05-08'),
          helpText: 'The settlement/maturity date of the forward contract',
          validators: [
            (value, formData) => {
              if (!value || !formData || !formData.evaluation_date) return true
              if (value <= formData.evaluation_date) {
                return 'Settlement date must be after evaluation date'
              }
              return true
            }
          ]
        ...
        },
        {
          ...
          minFractionDigits: 2,
          maxFractionDigits: 4,
          helpText: 'The agreed forward price of the equity',
          validators: [
            (value) => {
              if (value <= 0) {
                return 'Forward price must be greater than 0'
              }
              return true
            }
          ]
