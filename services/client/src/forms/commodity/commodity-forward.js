export const commodityForwardForm = {
  name: 'Commodity Forward',
  category: 'COMMODITY',
  api: 'calculateCommodityForward',
  groups: [
    {
      title: 'Trade Details',
      collapsible: true,
      ...
      fields: [
        {
          ...
          helpText: 'The date at which the commodity forward will be valued'
        },
        {
          key: 'ticker',
          type: 'dropdown',
          ...
          filter: true,
          helpText: 'The commodity underlying the forward contract'
        },
        {
          key: 'currency',
          type: 'dropdown',
        ...
        },
        {
          ...
          minFractionDigits: 2,
          maxFractionDigits: 4,
          helpText: 'The agreed forward price of the commodity',
          validators: [
            (value) => {
              if (value <= 0) {
