export const commoditySpotForm = {
  name: 'Commodity Spot',
  category: 'COMMODITY',
  api: 'calculateCommoditySpot',
  groups: [
    {
      title: 'Trade Details',
      collapsible: true,
      ...
      fields: [
        {
          ...
          helpText: 'The date at which the commodity spot will be valued'
        },
        {
          key: 'ticker',
          type: 'dropdown',
          ...
          filter: true,
          helpText: 'The commodity underlying the spot transaction'
        },
        {
          key: 'currency',
          type: 'dropdown',
        ...
        },
        {
          ...
          helpText: 'The settlement date of the commodity spot (typically T+2)',
          validators: [
            (value, formData) => {
        ...
        },
        {
          ...
          minFractionDigits: 2,
          maxFractionDigits: 4,
          helpText: 'The current spot price of the commodity',
          validators: [
            (value) => {
              if (value <= 0) {
